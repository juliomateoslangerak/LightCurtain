...
Curtains = LED_curtains(neopixels_pin=pixels,led_number=LED_NUMBER,curtain_start=CURTAIN_START,curtain_reverse=CURTAIN_REVERSE,curtain_sensors=[sensor_right, sensor_left],
curtain_offsets=CURTAIN_OFFSETS,mirror_relative_width=MIRROR_RELATIVE_WIDTH,mirror_offset=MIRROR_OFFSET,start_threshold=START_THRESHOLD,
timed_wave_stop=TIMED_WAVE_STOP,power=POWER)
Curtains.test_strip([(255,0,0,0), (0, 255, 0, 0), (0, 0, 255, 0), (0, 0, 0, 255)])
while True:
 if any(sensor_left.range > START_THRESHOLD,sensor_right.range > START_THRESHOLD):
